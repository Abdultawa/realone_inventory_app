...
<body id="kt_body" class="app-blank bgi-size-cover bgi-attachment-fixed bgi-position-center">
    ...
    <div class="d-flex flex-column flex-root" id="kt_app_root">
        ...
        <div class="d-flex flex-column flex-lg-row flex-column-fluid container align-items-center">
            <!--begin::Aside-->
            <div class="col-md-3">
                <div class="d-flex flex-lg-row-fluid">
                    ...
                    <div class="d-flex flex-column flex-center pb-0 pb-lg-10 p-10 w-100">
                        ...
                        <!--end::Image-->
                        <!--begin::Title-->
                        <h1 class="text-gray-800 fs-2qx fw-bold text-center mb-7">Secured eConsular Identity</h1>
                        <!--end::Title-->
                        <!--begin::Text-->
                        <div class="text-gray-600 fs-base text-center fw-semibold">
                            <p class="text-dark w-sm-80 m-auto">Access your personal consular services securely and conveniently online. Log in to manage your identity, view applications, and update information—all within a safe and protected environment.</p>
                        </div>
                        <!--end::Text-->
                    </div>
                    <!--end::Content-->
            ...
            <!--begin::Body-->
                <div class="col-md-9">
                    <div class="d-flex_ flex-column-fluid ">
                        <!--begin::Wrapper-->
                        <div class="bg-body d-flex_ flex-column_  rounded-1 w-md-600px_ p-10">
                            <!--begin::Content-->
                            <div class="h-lg-100 w-md-400px_">

                                <!--begin::Logo image-->
                                    <div class="logo-wrap my-4">
                                        <a href="{{ route('dashboard.index') }}">
                                            <img alt="Logo" src="{{ asset('modules/metronic_v8.2.7/media/logos/custom-1.png')}}" class="h-50px h-lg-60px theme-light-show" />
                                            <img alt="Logo" src="{{ asset('modules/metronic_v8.2.7/media/logos/custom-1.png')}}" class="h-50px h-lg-60px theme-dark-show" />
                                        </a>
                                    </div>
                                <!--end::Logo image-->
